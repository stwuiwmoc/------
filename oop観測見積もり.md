...
| パラメータ   | Altitude | Latitude | PWV  | Zenith Angle | ファイル名 |
| ------------ | -------- | -------- | ---- | ------------ | ---------- |
| 単位         | ft       | deg      | um   | deg          |            |
| 10月, 良条件 | 9973.754 | 30       | 2000 | 22           |            |
| 10月, 平均的 | 同上     | 同上     | 5000 | 同上         |            |
| 11月, 良条件 | 同上     | 同上     | 2000 | 23           |            |
| 11月, 平均的 | 同上     | 同上     | 5000 | 同上         |            |
|              |          |          |      |              |            |
...
| ------------ | -------- | -------- | ----- | ------------ | ---------- |
| 単位         | ft       | deg      | um    | deg          |            |
| 10月, 平均的 | 495.40   | 43       | 15000 | 45           |            |
| 11月, 平均的 | 同上     | 同上     | 8000  | 46           |            |
|              |          |          |       |              |            |
...
| ------------ | -------- | -------- | ----- | ------------ | ---------- |
| 単位         | ft       | deg      | um    | deg          |            |
| 10月, 平均的 | 1650.26  | 30       | 23000 | 35           |            |
| 11月, 平均的 | 同上     | 同上     | 15000 | 36           |            |
|              |          |          |       |              |            |
