...
| ------------ | -------- | -------- | ---- | ------------ | -------------------------------- |
| 単位         | ft       | deg      | um   | deg          |                                  |
| 10月, 良条件 | 9973.754 | 30       | 2000 | 22           | Ha_PWV2000_ZA22_Range3to4_R0.csv |
| 10月, 平均的 | 同上     | 同上     | 5000 | 同上         | Ha_PWV5000_ZA22_Range3to4_R0.csv |
| 11月, 良条件 | 同上     | 同上     | 2000 | 23           | Ha_PWV2000_ZA23_Range3to4_R0.csv |
| 11月, 平均的 | 同上     | 同上     | 5000 | 同上         | Ha_PWV5000_ZA23_Range3to4_R0.csv |
|              |          |          |      |              |                                  |
...
| ------------ | -------- | -------- | ----- | ------------ | --------------------------------- |
| 単位         | ft       | deg      | um    | deg          |                                   |
| 10月, 平均的 | 495.40   | 43       | 15000 | 45           | Na_PWV15000_ZA45_Range3to4_R0.csv |
| 11月, 平均的 | 同上     | 同上     | 8000  | 46           | Na_PWV8000_ZA46_Range3to4_R0.csv  |
|              |          |          |       |              |                                   |
...
| ------------ | -------- | -------- | ----- | ------------ | --------------------------------- |
| 単位         | ft       | deg      | um    | deg          |                                   |
| 10月, 平均的 | 1650.26  | 30       | 23000 | 35           | Hi_PWV23000_ZA35_Range3to4_R0.csv |
| 11月, 平均的 | 同上     | 同上     | 15000 | 36           | Hi_PWV15000_ZA36_Range3to4_R0.csv |
|              |          |          |       |              |                                   |
...
| $I' _{ATM} $             | W / m $^2 $ / sr / m | 光学系の熱輻射による分光放射輝度 |
|                          |                      |                                  |

望遠鏡の熱輻射は、地球大気を黒体と見なしてプランクの法則から分光放射輝度を計算し、そこに放射率をかければ良い。放射率は（1 - 透過率）で表すことができるため
